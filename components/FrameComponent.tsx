        ...
        <AnimatePresence>
          {showOverlay && (
            <motion.div
              ...
              className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center p-8"
              style={{ zIndex: 3 }}
            >
              <motion.h3
                ...
                className="text-white text-3xl font-bold mb-3 text-center"
              >
                {title}
              </motion.h3>
              <motion.p
                ...
                className="text-white/80 text-sm mb-6 text-center max-w-md"
              >
                {description}
              </motion.p>
              <motion.div
